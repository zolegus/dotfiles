...
function nvim-jm
    env NVIM_APPNAME=nvim-jm nvim $argv
end
...
function nvim-k
    env NVIM_APPNAME=nvim-k nvim $argv
end

function nvims
    set items nvim-astro nvim-chad nvim-scratch nvim-go nvim-mini nvim-lunar nvim-jm nvim-lazy nvim-k
