...
abbr bo "brew outdated | fzf -m | xargs brew upgrade"
abbr boc "brew outdated --cask"
abbr br "brew reinstall"
abbr brc "brew reinstall --cask"
abbr bs "brew search"
...
abbr j "joshuto"
abbr ip "printf 'curl: ';curl ifconfig.me;printf '\nodns: ';dig +short myip.opendns.com @resolver1.opendns.com; printf 'wget: '; wget -qO- ipinfo.io/ip"
abbr ipi "curl ipinfo.io"
...
abbr llm "exa -l -g -s=date --icons"
abbr lls "exa -l -g -s=size --icons"
abbr lla "exa -l -a -g --icons"
abbr llma "exa -l -a -g -s=date --icons"
abbr llsa "exa -l -a -g -s=size --icons"
