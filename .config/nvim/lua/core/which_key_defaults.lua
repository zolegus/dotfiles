return {
	...
	e = { "<cmd>Neotree float focus toggle<CR>", "File Explorer" },
	o = { "<cmd>Neotree float git_status toggle<CR>", "Git Explorer" },
	q = { ":confirm q<CR>", "Quit" },
	...
	r = {
		...
		j = { "<cmd>RustLsp joinLines<cr><cr>", "Join Lines" },
		h = {
			"Inlay hits",
		...
		z = { "<cmp>RustLsp reloadWorkspace<cr>", "Reload Workspace" },
	},
	c = {
		name = "+Codes",
		c = {
